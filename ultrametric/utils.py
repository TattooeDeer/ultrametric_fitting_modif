...
class Experiments:
    ...
    def __init__(self, sets):
        ...
        self.shower = {}
        print(sets['batch_1'].keys())
        get_list = lambda key, sets: [sets[set_name][key] for set_name in sets]
        
        self.shower["clustering"] = lambda name: (plot_clustering, get_list("X_cpu", self.sets), get_list("y", self.results[name]))
    ...
    def get_data(self, set_name, *others):
        names = ["X", "X_cpu", "y", "y_cpu", "n_clusters", "labeled"] + list(others)
